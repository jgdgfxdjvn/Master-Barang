...
<nav class="navbar navbar-expand-md navbar-dark bg-primary">
    <div class="container">
        <link href="<?php echo e(asset('images/stefi.jpg')); ?>" rel="stylesheet">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav flex-row flex-wrap">
                ...
                <li class="nav-item col-2 col-md-auto"><a href="<?php echo e(route('barangs.index')); ?>"
                        class="nav-link <?php if($currentRouteName == 'barangs.index'): ?> active <?php endif; ?>">Barang</a></li>
            </ul>
            <hr class="d-md-none text-white-50">
...
<?php /**PATH C:\xampp\htdocs\masterbarang\resources\views/layouts/nav.blade.php ENDPATH**/ ?>